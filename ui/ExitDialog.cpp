...
void ExitDialog::setIcon(QString type)
{
    if(type == "error") {
        ...
        QPixmap logo(":/icons/help.png");
        ui->lab_mbox_icon->setPixmap(logo);
    }
}

void ExitDialog::setBodyText(QString text)
{
    ui->lab_mess_body->setText(text);
}

void ExitDialog::setButtonText(const QString& text1, const QString& text2)
{
...
void ExitDialog::setButtonText(const QString& text)
{
...
void ExitDialog::on_btn_system_close_clicked()
{
    //发送信号
    btnchicked(0);
    //关闭窗口
...
void ExitDialog::on_btn_mbox_btn01_clicked()
{
    //发送信号
    btnchicked(1);
    //关闭窗口
...
void ExitDialog::on_btn_mbox_btn02_clicked()
{
    //发送信号
    btnchicked(2);
    //关闭窗口
